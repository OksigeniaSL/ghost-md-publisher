...
function readArticle(mdPath) {
  ...
  if (!data.slug || typeof data.slug !== 'string') errors.push('slug (string) requerido');
  if (!Array.isArray(data.tags) || data.tags.length === 0) errors.push('tags (array no vacío) requerido');
